...
def main() -> None:
    ...
    train_collate = lambda rows: collate_fn(
        ...
        cfg.data.question_padding_side, cfg.data.eos_mode,
    )
    ...
    validation_loader = DataLoader(
        ...
        shuffle=False, collate_fn=lambda rows: collate_fn(rows, tokenizer, cfg.data.max_context_tokens, cfg.data.max_question_tokens, cfg.data.max_answer_tokens, cfg.data.append_eos, cfg.data.use_chat_template, cfg.data.chat_template_enable_thinking, cfg.data.qa_per_context, False, cfg.data.question_padding_side, cfg.data.eos_mode),
    )
